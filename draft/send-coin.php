...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($newSend === 'insufficient') {
            echo "<script>alert('You do not have sufficient blue-coin')</script>";
        }
        else if($newSend === 'updSuccess'){
            echo "<script>alert('Successfull')</script>";
        }
        else if($newSend === 'upderror'){
            echo "<script>alert('Successfull, but transaction not inserted')</script>";
        }
        else if($newSend === 'updError'){
            echo "<script>alert('Successfull, error updating amount')</script>";
        }
        else if($newSend === 'wdne'){
            echo "<script>alert('Wallet does not exist')</script>";
        }
        else{
            echo "<script>alert('Unknwn error')</script>";
        }
    }
