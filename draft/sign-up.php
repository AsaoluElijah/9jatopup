<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($newReg === "exist") {
            ...
            $success = true;
            // $cookie = setcookie('9JATOPUP',$wallet, time() + (86400 * 30), "/");
...
<head>
    ...
    <!-- Site Title  -->
    <title>9JATOPUP | Buy affordble airtime and data to browse the web</title>
    <!-- Vendor Bundle CSS -->
            ...
            <div class="page-ath-form">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="input-item text-left">
                        <input required class="input-checkbox input-checkbox-md" id="term-condition" type="checkbox"><label for="term-condition">I agree to 9JATOPUP <a
...
?>
    <script>
        // success();
        location.href = 'success.php?event=regSuccess';
    </script>
<?php }
    if (isset($error)) {
?>
